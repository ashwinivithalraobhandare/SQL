...
use college_info;
CREATE TABLE college_info(college_id int,college_name varchar(100)not null,location varchar(255),established_year int,constraint established_year check (established_year>1800),college_email varchar(100) unique);
