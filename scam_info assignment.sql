...
update scam_info1 set scam_city='delhi' where scam_no=5;

delete from scam_info1 where scam_no=6;
delete from scam_info1 where scam_no=11;
delete from scam_info1 where scam_no=18;

select * from scam_info1 where scam_no=3 and scam_job='shop';
select * from scam_info1 where scam_no=1 or scam_city='Bangalore';

select * from scam_info1 where scam_no in(1,2,3,4);
